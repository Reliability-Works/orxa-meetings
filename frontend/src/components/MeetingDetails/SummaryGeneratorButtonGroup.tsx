...
interface ModelGenerateCheckOptions {
  modelConfig: ModelConfig;
  customPrompt: string;
  onGenerateSummary: (customPrompt: string) => Promise<void>;
  setSettingsDialogOpen: (open: boolean) => void;
  setIsCheckingModels: (checking: boolean) => void;
}

async function checkBuiltInAIModelsAndGenerate({
  modelConfig,
  customPrompt,
  onGenerateSummary,
  setSettingsDialogOpen,
  setIsCheckingModels,
}: ModelGenerateCheckOptions) {
...
async function checkOllamaModelsAndGenerate(options: ModelGenerateCheckOptions) {
  const {
    modelConfig,
    customPrompt,
    onGenerateSummary,
  ...
  if (modelConfig.provider === "builtin-ai") {
    await checkBuiltInAIModelsAndGenerate(options);
    return;
  }
