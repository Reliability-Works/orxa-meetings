# GPU-accelerated development script for Orxa (Windows PowerShell)
# Automatically detects and runs in development mode with optimal GPU features

Write-Host "GPU-Accelerated Development Mode for Orxa" -ForegroundColor Blue
Write-Host ""
...
Write-Host ""
Write-Host "Starting Orxa in development mode..." -ForegroundColor Blue
Write-Host ""
