@echo off
REM Orxa Build Script for Windows
...
echo 🚀 Building Orxa application...
...
echo.
echo DESCRIPTION:
echo   This script builds the Orxa Tauri application for Windows.
