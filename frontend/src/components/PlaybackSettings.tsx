    ...
    <div className="flex flex-col gap-6">
        ...
        <div className="flex items-start gap-2">
          ...
          <div>
            ...
            <p className="mt-1 text-sm text-gray-500">
              Meeting summaries can be read aloud today with the local macOS speech engine from the
              summary toolbar. Downloadable voice models stay in the research area until Orxa has a
              dedicated local voice runtime.
            </p>
          </div>
        </div>
      </section>
      ...
      <section>
        ...
        <p className="mb-4 text-sm text-gray-500">
          Download local TTS model artifacts for research and benchmarking. Downloaded models are
          cached locally; the active playback path remains the built-in macOS speech engine.
        </p>
