        ...
        {isParakeet && (
          <div className="p-2 bg-amber-50 border border-amber-200 rounded text-amber-800">
            ...
            <p className="mt-1 text-xs">
              Parakeet currently only supports automatic language detection. Manual language
              selection is not available. Use Whisper if you need to specify a particular language.
            </p>
          </div>
        )}
        ...
        <div className="text-xs space-y-2 pt-2">
          ...
          {selectedLanguage === "auto" && (
            <div className="p-2 bg-yellow-50 border border-yellow-200 rounded text-yellow-800">
              ...
              <p className="mt-1">
                For best accuracy, select your specific language (e.g., English, Spanish, etc.)
              </p>
            </div>
          )}
          {selectedLanguage === "auto-translate" && (
            <div className="p-2 bg-blue-50 border border-blue-200 rounded text-blue-800">
              ...
              <p className="mt-1">
                All audio will be automatically translated to English. Best for multilingual
                meetings where you need English output.
              </p>
            </div>
          )}
