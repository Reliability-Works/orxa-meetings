...
use super::types::{ModelConfig, TranscriptConfig};
use crate::{database::repositories::setting::SettingsRepository, state::AppState};

pub(super) async fn api_get_model_config<R: Runtime>(
    _app: AppHandle<R>,
    ...
    match SettingsRepository::get_model_config(pool).await {
        ...
        Ok(None) => {
            log_warn!("No model config found in database");
            Ok(None)
        }
        Err(e) => {
...
pub(super) async fn api_save_model_config<R: Runtime>(
    _app: AppHandle<R>,
    state: tauri::State<'_, AppState>,
    provider: String,
    model: String,
...
pub(super) async fn api_get_api_key<R: Runtime>(
    _app: AppHandle<R>,
    state: tauri::State<'_, AppState>,
    provider: String,
    _auth_token: Option<String>,
...
pub(super) async fn api_get_transcript_config<R: Runtime>(
    _app: AppHandle<R>,
    state: tauri::State<'_, AppState>,
    _auth_token: Option<String>,
...
pub(super) async fn api_save_transcript_config<R: Runtime>(
    _app: AppHandle<R>,
    state: tauri::State<'_, AppState>,
    provider: String,
    model: String,
...
pub(super) async fn api_get_transcript_api_key<R: Runtime>(
    _app: AppHandle<R>,
    state: tauri::State<'_, AppState>,
    provider: String,
    _auth_token: Option<String>,
...
pub(super) async fn api_delete_api_key<R: Runtime>(
    _app: AppHandle<R>,
    state: tauri::State<'_, AppState>,
    provider: String,
    _auth_token: Option<String>,
