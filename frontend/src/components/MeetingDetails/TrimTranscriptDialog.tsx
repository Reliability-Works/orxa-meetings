...
export function TrimTranscriptDialog({
  ...
  const cutoffSeconds = useMemo(() => parseCutoffSeconds(cutoffInput), [cutoffInput]);
        ...
        <div className="space-y-4">
          <div className="space-y-2">
            ...
            <p className="text-xs text-gray-500">
              Exact cutoff matches are kept. Segments without recording timestamps are left
              untouched.
            </p>
          </div>
          ...
          {preview && (
            <div className="space-y-3">
              ...
              <SegmentPreview
                label="First removed segment"
                segment={preview.first_removed_segment}
              />
