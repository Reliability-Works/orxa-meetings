...
When **reviewing recordings** in Orxa, we recommend using **computer speakers** or **wired headphones** rather than Bluetooth headphones for accurate playback.
...
1. **Orxa records at 48kHz** (professional audio standard)
...
- ❌ **Reviewing Orxa recordings** - Use wired/speakers instead
...
### This is Not a Orxa Bug

The issue is in **macOS's Bluetooth audio stack**, not in Orxa's recording engine.
...
**A**: This is a macOS/Bluetooth limitation, not a Orxa bug. We've correctly recorded at 48kHz.
...
**A**: Yes! Orxa now shows a warning when Bluetooth headphones are active during playback.
