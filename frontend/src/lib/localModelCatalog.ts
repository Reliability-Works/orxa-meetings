...
export const EXPERIMENTAL_TRANSCRIPTION_MODELS: LocalModelCatalogItem[] = [
  ...
  },
  {
    ...
    notes:
      "Promising realtime quality, but needs an MLX or sidecar runtime before Orxa can run it.",
  },
  {
    id: "qwen3-asr-1.7b",
    name: "Qwen3-ASR 1.7B",
  ...
  },
  {
    ...
    cons: ["Not wired into Orxa.", "Speaker attribution still needs product and privacy design."],
  ...
  },
  {
    ...
    notes:
      "Worth benchmarking, but likely less meeting-focused than Whisper or streaming ASR models.",
  },
];
...
export const PLAYBACK_MODELS: LocalModelCatalogItem[] = [
  ...
  },
  {
    ...
    cons: ["Heavier integration than Kokoro.", "Needs careful local packaging before default use."],
