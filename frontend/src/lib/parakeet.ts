...
export const MODEL_DISPLAY_CONFIG: Record<string, ModelDisplayInfo> = {
  ...
  "parakeet-tdt-0.6b-v2-int8": {
    ...
    pros: ["Small realtime model footprint.", "Good when disk and startup cost matter."],
    cons: [
  ...
  "parakeet-tdt-0.6b-v3-fp32": {
    ...
    cons: ["Much larger download.", "Slower than the Lightning Int8 default."],
    tier: "precise",
  },
};
...
export function getModelPerformanceBadge(quantization: QuantizationType): {
  label: string;
  color: string;
} {
  switch (quantization) {
